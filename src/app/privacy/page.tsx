  ...
  return (
    ...
    >
      ...
      <div className="card flex flex-col gap-3" style={{ fontSize: 13, lineHeight: 1.6, color: "var(--text-secondary)" }}>
        ...
        По вопросам, связанным с обработкой данных: <span style={{ color: "var(--primary-dark)" }}>support@reveli.app</span></p>
